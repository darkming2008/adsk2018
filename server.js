...
console.log("Issue Ping Good Status: "+ l1/k*100 +" %");
console.log("Dos Ping Good Status: "+ l2/k*100 +" %");
console.log("Folder Notification Good Status: "+ l3/k*100 +" %");
console.log("ACM Good Status: "+ l4/k*100 +" %");
console.log("OSS Ping Good Status: "+ l5/k*100 +" %");
//***
  });
});
